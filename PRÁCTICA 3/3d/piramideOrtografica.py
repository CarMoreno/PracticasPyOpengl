...
"""En este archivo haremos el punto 1 y 2 (Paralela Ortografica con sus correspondientes LookAt) para la Piramide 3d""""
...
def init(): 
  ...
  #glOrtho(-0.4, 0.3, -0.6, 1, 0.3, -1) # Proyeccion paralela 2
  glOrtho(-0.8, 1, -0.5, 1, -0.5, 0.9) # Proyeccion paralela 3
